...

{
    ...
    for (int i = 0; i < NUMBER_OF_ITEMS; i++)
    {
        ...
        backgroundScrollingMenuItems.element[i].setColor(Color::getColorFrom24BitRGB(0xFF, 0xFF, 0xFF));
        ...
        centerScrollingMenuItems.element[i].setColor(Color::getColorFrom24BitRGB(0xFF, 0xFF, 0xFF));
